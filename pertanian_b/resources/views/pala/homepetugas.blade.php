            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="{{url('login')}}"><i class="fa fa-gear fa-fw"></i> Login</a>
                        </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('petugas1/petani2')}}">Data Petani</a>
                                </li>
                                <li>
                                    <a href="{{url('petugas1/lahan2')}}">Data Lahan</a>
                                </li>
                                <li>
                                    <a href="{{url('petugas1/hasil_tani2')}}">Data Hasil Pertanian</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('petugas1/distributor2')}}">Data Distributor</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('petugas1/membeli2')}}">Data Transaksi</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
