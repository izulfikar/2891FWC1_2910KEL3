                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('petani1')}}">Data Petani</a>
                                </li>
                                <li>
                                    <a href="{{url('admin1/lahan1')}}">Data Lahan</a>
                                </li>
                                <li>
                                    <a href="{{url('admin1/hasil_tani1')}}">Data Hasil Pertanian</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('admin1/distributor1')}}">Data Distributor</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('admin1/membeli1')}}">Data Transaksi</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('admin1/pengguna1')}}">Data Pengguna</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{url('admin1/admin1')}}">Data Admin</a>
                                </li>
                                <li>
                                    <a href="{{url('admin1/petugas1')}}">Data Petugas</a>
                                </li>
                                <li>
                                    <a href="{{url('admin1/pelanggan1')}}">Data Pelanggan</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
